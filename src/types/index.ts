...
export interface SAFETerms {
  ...
  discount?: number | undefined; // percentage (e.g., 20 for 20%)
  mfn?: boolean | undefined; // Most Favored Nation
}
...
export interface FundingRound {
  ...
  valuation?: number | undefined; // for priced rounds
  isPreMoney: boolean; // for valuation
  safeTerms?: SAFETerms | undefined; // for SAFE rounds
  esopAdjustment?: {
    newPoolSize: number; // percentage
    isPreMoney: boolean;
  } | undefined;
  founderSecondary?: {
    founderId: string;
